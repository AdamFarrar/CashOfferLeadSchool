...
describe("renderEmail", () => {
    it("should inject placeholder values into HTML", async () => {
        ...
        const result = await renderEmail(html, subject, data);
    ...
    it("should leave unreplaced placeholders as empty strings", async () => {
    ...
    it("should sanitize XSS in input HTML", async () => {
    ...
    it("should handle empty HTML gracefully", async () => {
        const result = await renderEmail("", "Subject", {});
